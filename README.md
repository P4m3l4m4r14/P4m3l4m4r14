<div align="center">
  <img height="150" src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNHJueXF4eXJueXF4eXJueXF4eXJueXF4eXJueXF4eXJueXF4eXAmb3BpPTgxMzg0NjQzJmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCBjdD1z/3ohzdIuqJoo8QdK2CQ/giphy.gif"  />
  <h1>Olá, eu sou a Pâmela Frota! 🌸</h1>
  <p><i>Estudante de Engenharia de Computação @ UFC Sobral | Desenvolvedora Full-Stack & entusiasta de Robótica</i></p>
</div>

---

### 💫 Sobre Mim
- 🎓 Cursando **Engenharia de Computação** na Universidade Federal do Ceará (UFC), campus Sobral (Previsão: 2028).
- 🚀 Atualmente **Trainee na Loading Jr.**, focada em desenvolvimento mobile com React.
- 🤖 Membro da **Célula de Robótica do Nuclic** (Apoio técnico) e do **PET Engenharia de Computação**.
- 🛠️ Desenvolvendo o projeto **SIC (Sistema Integrado de Caronas)** para a região de Sobral.
- 🌍 Apaixonada por cultura asiática, idiomas (Francês B1!).
